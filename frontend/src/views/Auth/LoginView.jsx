      ...
      <div className="login-card">
        ...
        {isSignupMode ? (
          <>
            ...
            <div className="login-toggle-mode" style={{ marginTop: 15, fontSize: 13 }}>
        ...
        <div style={{ fontSize: 11, color: 'rgba(255,255,255,0.4)', marginTop: 24, display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 6 }}>
          <ShieldCheck size={13} /> ArioNex Commercial AI Platform · Version 1.0.0
        </div>
      </div>
    </div>
  );
